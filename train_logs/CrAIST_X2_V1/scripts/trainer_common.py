    ...
    def train(self):
        ...
        for epoch in range(start, total_epoch):
            for step in range(step_epoch):
                ...
                del hr, lr, generated_hr, loss_curr, loss_l1
                ...
                if (step + 1) % log_frep == 0:
                    ...
                    #     format(self.config["version"], elapsed, epoch + 1, total_epoch, step + 1, step_epoch, 
                    #             loss_cur_scalar,loss_l1_scalar))
                    ...
                    if self.config["use_tensorboard"]:
                        ...
                        self.tensorboard_writer.add_scalar('data/loss', loss_cur_scalar, cum_step)
                        self.tensorboard_writer.add_scalar('data/l1', loss_l1_scalar, cum_step)
                        # self.tensorboard_writer.add_scalar('data/ploss', loss_per.item(), cum_step)
